...
class HumanGateMonitor:
    ...
    def check_approval_quality(self, reviews: List[Review]) -> bool:
        ...
        if (
            approval_rate > self.approval_rate_threshold
            and avg_review_time < self.min_review_time_seconds
        ):
            return False
    ...
    def record_review(
        self, approved: bool, duration_seconds: float, reviewer_id: Optional[str] = None
    ) -> None:
        """Record a review
