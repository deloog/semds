...
"""
            ...
            error_type = self._classify_error(result.error_message) if not success else None
    ...
    def show_stats(self):
        ...
        print(f"  Success rate: {self.session_success/self.session_tasks*100:.1f}%" if self.session_tasks > 0 else "  N/A")
