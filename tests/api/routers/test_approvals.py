...
class TestListPendingApprovals:
    ...
    def test_list_pending_approvals_returns_list(self, mock_db_session, mock_user, auth_headers):
        """应返回待审批列表"""
...
class TestApproveRequest:
    ...
    def test_approve_request_returns_success(self, mock_db_session, mock_pending_approval, mock_user, auth_headers):
        """批准请求应返回成功"""
        from api.main import app
        from api.dependencies import get_db_session
        from api.auth.dependencies import get_current_user
    ...
    def test_approve_nonexistent_request_returns_404(self, mock_db_session, mock_user, auth_headers):
        """批准不存在的请求应返回404"""
        from api.main import app
        from api.dependencies import get_db_session
        from api.auth.dependencies import get_current_user
...
class TestRejectRequest:
    ...
    def test_reject_request_returns_success(self, mock_db_session, mock_pending_approval, mock_user, auth_headers):
        """拒绝请求应返回成功"""
        from api.main import app
        from api.dependencies import get_db_session
        from api.auth.dependencies import get_current_user
    ...
    def test_reject_without_comment_returns_error(self, mock_db_session, mock_pending_approval, mock_user, auth_headers):
        """拒绝请求应要求填写意见"""
        from api.main import app
        from api.dependencies import get_db_session
        from api.auth.dependencies import get_current_user
...
class TestApprovalStateMachine:
    ...
    def test_approve_already_approved_request_returns_400(self, mock_db_session, mock_user, auth_headers):
        """已批准的请求再次批准应返回400"""
        from api.main import app
        from api.dependencies import get_db_session
        from api.auth.dependencies import get_current_user
    ...
    def test_reject_already_rejected_request_returns_400(self, mock_db_session, mock_user, auth_headers):
        """已拒绝的请求再次拒绝应返回400"""
        from api.main import app
        from api.dependencies import get_db_session
        from api.auth.dependencies import get_current_user
...
class TestApprovalRequestCreation:
    ...
    def test_create_approval_request_returns_201(self, mock_db_session, mock_user, auth_headers):
        """创建审批请求应返回201"""
        from api.main import app
        from api.dependencies import get_db_session
        from api.auth.dependencies import get_current_user
