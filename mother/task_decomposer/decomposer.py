...
class TaskDecomposer:
    ...
    def decompose(self, task_description: str) -> TaskGraph:
        ...
        # 2. 获取分解模式
        pattern = self.decomposition_patterns.get(task_category, 
                                                   self._generate_generic_pattern())
    ...
    def _categorize_task(self, description: str) -> str:
        ...
        elif any(word in desc_lower for word in ["pipeline", "workflow", "etl", "process"]):
