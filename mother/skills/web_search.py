    ...
    def _mock_search_results(self, query: str, num_results: int) -> List[SearchResult]:
        ...
        mock_data = {
            'python': [
                ...
                ('Python Tutorial - W3Schools', 'https://www.w3schools.com/python/', 'Learn Python programming'),
            ],
            'error': [
                ('Stack Overflow - Python Questions', 'https://stackoverflow.com/questions/tagged/python', 'Community Q&A'),
                ('Python Error Handling Guide', 'https://docs.python.org/3/tutorial/errors.html', 'Official error handling tutorial'),
            ],
            'html': [
                ('MDN Web Docs - HTML', 'https://developer.mozilla.org/en-US/docs/Web/HTML', 'HTML documentation'),
