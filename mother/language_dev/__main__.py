...
from mother.language_dev.language_learner import LanguageLearner, LanguageSpec, create_ai_native_language_spec
...
def main():
    ...
    # learn command
    learn_parser = subparsers.add_parser('learn', help='Learn a new programming language')
    learn_parser.add_argument('--spec', help='Language specification JSON file')
    learn_parser.add_argument('--create-example', action='store_true', help='Create example AILang')
