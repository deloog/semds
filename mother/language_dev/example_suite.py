...
class ExampleSuiteGenerator:
    ...
    def generate_full_suite(self, language: str, output_dir: str) -> Dict:
        ...
        applications = self._generate_applications(language, output_path / "05_applications")
...
if __name__ == "__main__":
    # 演示
    from mother.language_dev.language_learner import LanguageLearner, create_ai_native_language_spec
