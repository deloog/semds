...
def demo_create_custom_language():
    ...
    flowlang_spec = LanguageSpec(
        ...
        keywords=[
            "let", "fn", "stream", "node", "pipeline",
            "source", "sink", "map", "filter", "reduce",
            "merge", "split", "buffer", "window", "trigger",
            "async", "await", "parallel", "batch"
        ],
...
'''
    ...
    print(f"    python -m mother.language_dev generate --lang flowlang --output {output_dir}")
