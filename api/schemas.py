...
class TaskCreate(BaseModel):
    ...
    success_criteria: Optional[Dict] = Field(default_factory=dict, description="成功标准")
...
class EvolutionProgress(BaseModel):
    ...
    status: TaskStatus = Field(..., description="任务状态")
    recent_generations: List[GenerationResponse] = Field(default_factory=list, description="最近进化代")
